   ...
   ${index !== features.length - 1 ? "mb-6" : "mb-0"}  feature-card `}  >
    ...
    <div className="flex-1 flex flex-col ml-3">
      <h4 className="font-poppins font-semibold
       ...
       text-dimWhite text-[15px] leading-[24px]  ">
          {content}
        </p>
    </div>
  </div>
    ...
    <section id="features" className={layout.section} >
      <div className={layout.sectionInfo}>
       <h2 className={styles.heading2}>You do the business, <br className="sm:block hidden" />
        ...
        <p className={`${styles.paragraph} max-w-[400px] mt-5 `}>With the right credit card, you can improve your 
          financial life by building credit, earning rewards
           and saving money. But with hundreds of credit cards on the market.</p>
