    ...
    <section className={`${styles.flexCenter} ${styles.paddingY}
     flex flex-col`}  >
      ...
      flex-col mb-8  w-full `}  >
        ...
        mr-10" >
        <img src={logo} alt="hoolbank"
        className="w-[278px] h-[80px] object-contain 
        " />
        ...
        justify-between flex-wrap md:mt-0 mt-10" >
           {footerLinks.map((footerLinks) =>(
            ...
            className="flex flex-col ss:my-0 
            my-4 min-w-[150px]">
              ...
              <ul className="list-none mt-4">
                {footerLinks.links.map((link,index) =>(
                  ...
                  ${index !== footerLinks.links.length -1 ? 'mb-4' :
                   'mb-0' } `} >
                      {link.name}
                  </li>
                ))}
      ...
      border-t-[#3f3r45]  ">
        <p className="font-poppins font-normal  text-center 
          text-[18px]  leading-[27px] text-white " >
          2021 Hoolbank .All Rights Reserved
        </p>
